...
import com.stratio.querier.queryproviders.hardcoded.{HardcodedQueries01, TPCDSSelection}
...
object Querier extends App {
  ...
  val querySource = new TPCDSSelection //new DirectoryQueryProvider("./tests_queries/")
